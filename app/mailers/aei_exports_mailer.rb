class AeiExportsMailer < ApplicationMailer
  ...
  def export_bilan(failure_full_names, already_subscribed_full_names, outdated_licence_full_names, too_young_to_participate_full_names, too_old_to_participate_full_names, unavailable_for_genre_full_names, competition)
